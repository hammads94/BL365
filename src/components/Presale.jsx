import bcplogo from '../assets/images/image.png';
    ...
    return(
        <div className='presaleDiv text'>
            ...
            <div style={{marginTop:"20px"}}>
                ...
                <Button id='loginBtn' onClick={connect} className='walletBtn'></Button>
            </div>
            :
            <>
            {!correctChain?
            ...
            <div style={{marginTop:"20px"}}>
                ...
                <Button className='buy-button' id='buyBtn' style={{marginTop:'30px',borderRadius:'20px'}} variant='success' onClick={buy} disabled>Minimum Buy 0.1 <img style={{width:'15px'}} src={bnblogo}/></Button>
            </div>
            </div>
            :
